...
@section('content')
{{ Form::open(['route' => 'motivos.store', 'files'=> 'true']) }}
       @csrf
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  <h3>Registrar Motivo</h3>
            
			<div class="form-group">
            	<label for="">Nombre</label>
            	<input type="text" name="nombre" class="form-control" placeholder="Ingresar un motivo..." required autofocus>
            </div>
            <div class="form-group">
